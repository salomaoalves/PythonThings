...
#Criando Frame:
    ...
    myContainer1.pack()#transf em visuais as relações entres os mestres e escravos

#Criando butões(há 4 jeitos):
    #1:
    butao1 = Button(self.myContainer1)#cria e add o butao no container
    butao1["text"] = "Hello World"#nome q esta escrito no butao
    butao1["background"] = "green"#cor de fundo butao
